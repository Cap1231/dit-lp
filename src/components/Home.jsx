    ...
    <>
      ...
      <div className="faq">
        <Container maxWidth="md">
          ...
          >
            自動車整備管理システム、ECシステム、金融商品取引システム、予約サービスシステムなどになり、すべてAWS＋Ruby(on Rails)を中心に構築し、安定した運用保守を実現しております。<br/>
          ...
          >
            メルセデス・ベンツ日本様でのSAPと倉庫管理システムの運用をはじめ、スウォッチグループジャパン様他、物流業関係、サービス、小売業など幅広い業態にて、運用保守の実績がございます。<br/>
            詳細はお問い合わせください。
          </FaqItem>
          <FaqItem
